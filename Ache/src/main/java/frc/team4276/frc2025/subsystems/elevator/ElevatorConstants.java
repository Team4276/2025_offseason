...
public class ElevatorConstants {
    public static final LoggedTunableNumber stow = new LoggedTunableNumber("Elevator/StowPosition",
            Units.inchesToMeters(0.5));
    public static final LoggedTunableNumber intake = new LoggedTunableNumber("Elevator/IntakePosition",
            Units.inchesToMeters(0.0));
    public static final LoggedTunableNumber unjam = new LoggedTunableNumber("Elevator/UnjamPosition",
            Units.inchesToMeters(15.0));
    public static final LoggedTunableNumber l1 = new LoggedTunableNumber("Elevator/L1Position",
            Units.inchesToMeters(0.0));
    public static final LoggedTunableNumber l2 = new LoggedTunableNumber("Elevator/L2Position",
            Units.inchesToMeters(6.85));
    public static final LoggedTunableNumber l3 = new LoggedTunableNumber("Elevator/L3Position",
            Units.inchesToMeters(22.5));
    public static final LoggedTunableNumber lowAlgae = new LoggedTunableNumber("Elevator/LoAlgae",
            Units.inchesToMeters(10.0));
    public static final LoggedTunableNumber highAlgae = new LoggedTunableNumber("Elevator/HiAlgae",
            Units.inchesToMeters(17.32));
    public static final LoggedTunableNumber algaeChop = new LoggedTunableNumber("Elevator/AlgaeChop",
            Units.inchesToMeters(0.0));
    public static final LoggedTunableNumber climb = new LoggedTunableNumber("Elevator/Climb",
            Units.inchesToMeters(0.0));
    ...
    public static final Translation2d origin = new Translation2d(0.0, -Units.inchesToMeters(0.860191));
