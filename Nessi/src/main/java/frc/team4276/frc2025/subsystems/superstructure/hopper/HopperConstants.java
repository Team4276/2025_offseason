...
public class HopperConstants {
  ...
  public static final DoubleSupplier kS_left = new LoggedTunableNumber("Hopper/kS_left", 0.0);
  public static final DoubleSupplier kS_right = new LoggedTunableNumber("Hopper/kS_right", 0.0);
