...
public class AutoSelector extends VirtualSubsystem {
  ...
  public AutoSelector(AutoFactory autoFactory) {
    ...
    // routineChooser.addOption("4x Right: CDCD", () ->
    // this.autoFactory.poofs4xProcessorSide());
    // routineChooser.addOption("4x Left: LKLK", () ->
    // this.autoFactory.poofs4xBargeSide());
    // routineChooser.addOption("5x Right: ECDCD", () ->
    // this.autoFactory.poofsProcessorSide());
    // routineChooser.addOption("5x Left: JLKLK", () ->
